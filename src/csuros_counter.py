...
if __name__ == "__main__":
    ...
    for base in [1.5, 2.0, 4.0]:
        ...
        print(f"   Erro Absoluto Máximo: {analysis['overall']['max_absolute_error']:.2f}")
